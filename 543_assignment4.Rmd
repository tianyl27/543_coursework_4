...
GiniAge=readRDS(file=url(paste0(myWeb3,"GiniAndAge.rds")))
# ggplotly(GiniAge)
```
...
```{r}
CountryMap=readRDS(file=url(paste0(myWeb,"CountryMap.rds")))
ggplotly(CountryMap)
```
...
```{r}
WHRData2021
Map2021=readRDS(file=url(paste0(myWeb,"mapWorldVars.rds")))
# leaflet
```
